...
// --------------------- Form
// IDK <dialog className="backdrop:bg-stone-900/90 p-4 rounded-md shadow-md">...</dialog>
// <form className="mt-4 text-right">...</form>
// IDK <h2 className="text-xl font-bold text-stone-700 my-4">...</h2>
// IDK p className="text-stone-600 mb-4">...</p>
...
// IDK <p className="text-stone-800 my-4">...</p>
